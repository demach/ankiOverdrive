...
class Overdrive:
    ...
    def _disconnect(self, uuid) -> None:
        self.node_socket.send("DISCONNECT|{}\n".format(uuid).encode())

    def _connect(self, uuid) -> None:
    ...
    def _send_connect_message_to_socket(self, uuid) -> None:
    ...
    def _start_thread(self, target_function) -> None:
    ...
    def _location_changed_thread(self) -> None:
        while self._connected:
            try:
    ...
    def _handle_notification(self, command_id, data) -> None:
        # location notification
        #print(command_id, data)
        if command_id == '0x27':
            # parse location
        ...
        # transition notification
            ...
            print(struct.unpack_from("<H", data, 2)[0])
    ...
    def _standard_driving_policy(self, **kwargs) -> None:
        """
    ...
    def build_location_event(self, location, piece, offset, speed, clockwise, notification_time):
        return {
            ...
            'is_clockwise': f"{hex(clockwise) == '0x47'}"  # '0x47' is the code for clockwise=True
        }
    ...
    def change_speed(self, speed, accel) -> None:
        """
    ...
    def change_lane_right(self, speed, accel) -> None:
        """
    ...
    def change_lane_left(self, speed, accel) -> None:
        """
    ...
    def change_lane(self, speed, accel, offset) -> None:
        """
    ...
    def battery_level(self) -> None:
        self.send_command(b"\x1a")

    def turn(self) -> None:
        command = struct.pack("<Bbb", 0x32, 3,0)
        self.send_command(command)

    def turn_on_sdk_mode(self) -> None:
